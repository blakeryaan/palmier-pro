...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "hotfeditor-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "hotfeditor-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "hotfeditor-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "hotfeditor-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "hotfeditor-asset://x#junk") == "x")
    }
