...
extension MediaTab {
    static let folderDragScheme = "hotfeditor-folder://"
    static let assetDragScheme = "hotfeditor-asset://"
    ...
    /// A search "moment": `hotfeditor-asset://<id>#<start>-<end>` in source seconds
