...
struct MCPInstructionsPane: View {
    ...
    private var claudeCodeCommand: String {
        "claude mcp add --transport http hotf-editor \(mcpEndpoint)"
    }

    private var codexCommand: String {
        "codex mcp add hotf-editor --url \(mcpEndpoint)"
    }
    ...
    private var cursorDeepLink: URL? {
        ...
        return URL(string: "cursor://anysphere.cursor-deeplink/mcp/install?name=hotf-editor&config=\(encoded)")
    }
    ...
    private var overviewSection: some View {
        VStack(alignment: .leading, spacing: AppTheme.Spacing.sm) {
            ...
            Text("HoTF Editor exposes your open project as an MCP server. Connect any MCP clients to let it be your AI assistant.")
    ...
    private func openClaudeDesktopBundle() {
        ...
        let url = resourceURL.appendingPathComponent("hotf-editor.mcpb")
