...
enum MainMenuBuilder {
    ...
    private static func appMenu() -> NSMenuItem {
        let item = NSMenuItem()
        let menu = NSMenu(title: "HoTF Editor")
        menu.addItem(withTitle: "About HoTF Editor", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: "Quit HoTF Editor", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        item.submenu = menu
        return item
    }
