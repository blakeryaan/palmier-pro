...
/// Headless render: bake a `.hotf` project to a video file with no window,
...
///
/// CLI:
///   HoTFEditor --export <project.hotf> [--out file.mp4]
...
enum HeadlessExport {
    ...
    enum ParseError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .missingProject: "--export requires a path to a .hotf project"
    ...
    /// Decode `Timeline` + `MediaManifest` straight from the `.hotf` package
