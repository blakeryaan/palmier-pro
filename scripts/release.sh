...
PLIST="$ROOT/Sources/HoTFEditor/Resources/Info.plist"
...
NOTES_CLEAN="$(mktemp -t hotfeditor-release.XXXXXX).md"
...
BUILD_LOG="$(mktemp -t hotfeditor-build.XXXXXX).log"
...
url = f"https://github.com/thehotf/hotf-editor/releases/download/v{v}/HoTFEditor.dmg"
...
echo ""
echo "==> Released $TAG"
echo "    https://github.com/thehotf/hotf-editor/releases/tag/$TAG"
